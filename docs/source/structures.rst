...
At the core of ``dynts`` data structure stands
the :class:`dynts.DynData` abstract class. It is used
as base class for both :class:`dynts.TimeSeries` classes,
which are used for timeseries analysis, and :class:`dynts.xydata` class,
used for scatters.
